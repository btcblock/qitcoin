...
int64 nChainStartTime = 1465810312;
...
const string strMessageMagic = "QitCoin signed Message:\n";
...
//		nRewardCoinYear = 2 * MAX_MINT_PROOF_OF_STAKE;
    ...
    int64 nSubsidy = 15*nCoinAge * nRewardCoinYear / 365;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in QitCoin
    bool fStrictPayToScriptHash = true; // Always active in QitCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "QitCoin",CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "QitCoinV2 Launches. zaobi.org qq260682605";
...
//        CTransaction txNew(1, 1393221600, vin, vout, 0);
        ...
        assert(block.hashMerkleRoot == uint256("26d3f4b578faf3bd35472ddc5453859e14c2f526f112ba7c001f4634498f7292"));
