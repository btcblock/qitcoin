...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "QitCoin"+ FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"seed8", "dnsseed1.qtc.uqitcoin.com"},
    {"seed9", "dnsseed2.qtc.uqitcoin.com"},
    {"seed10", "dnsseed3.qtc.uqitcoin.com"},
    {"seed11", "dnsseed4.qtc.uqitcoin.com"},
    {"seed12", "dnsseed5.qtc.uqitcoin.com"},
    {"seed13", "dnsseed6.qtc.uqitcoin.com"},
    {"seed14", "dnsseed7.qtc.uqitcoin.com"},
    {"seed15", "dnsseed8.qtc.uqitcoin.com"},
    {"seed16", "dnsseed9.qtc.uqitcoin.com"},
    {"seed17", "dnsseed10.qtc.uqitcoin.com"},
    {"qtc","qtc.uqitcoin.com"},
    {"aa","139.129.92.101"},
    {"bb","211.149.161.104"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. QitCoin is probably already running."), addrBind.ToString().c_str());
        else
